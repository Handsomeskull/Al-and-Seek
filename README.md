...
- *Headless Training Mode:* Run simulations without graphics to train agents faster. Utilize all CPU cores and simulate thousands of rounds in seconds! (It all depends on your cpu's power)  
